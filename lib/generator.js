...
async function generate(personaPathOrObj, outputDir, options = {}) {
  ...
  cleanPersona.meta.frameworkVersion = cleanPersona.meta.frameworkVersion || '0.11.0';
  ...
  const agentCard = {
    ...
    version: persona.meta?.frameworkVersion || '0.11.0',
  ...
  manifest.meta = cleanPersona.meta || { framework: 'openpersona', frameworkVersion: '0.11.0' };
  manifest.acn = {
