...
async function generate(personaPathOrObj, outputDir, options = {}) {
  ...
  persona.hasDormantCapabilities = persona.hasSoftRefSkills || persona.hasSoftRefFaculties || persona.hasSoftRefBody || persona.heartbeatExpected;
  ...
  cleanPersona.meta.frameworkVersion = cleanPersona.meta.frameworkVersion || '0.10.0';
  ...
  manifest.meta = cleanPersona.meta || { framework: 'openpersona', frameworkVersion: '0.10.0' };
