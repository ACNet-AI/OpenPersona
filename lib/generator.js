...
async function generate(personaPathOrObj, outputDir, options = {}) {
  ...
  // Survival Policy: opt-in flag — economic self-awareness and tier-driven behavior
  // Default false: companion/roleplay personas track costs silently without interrupting user experience
  // Set economy.survivalPolicy: true in persona.json to activate
  persona.hasSurvivalPolicy = persona.hasEconomyFaculty && (persona.economy?.survivalPolicy === true);
