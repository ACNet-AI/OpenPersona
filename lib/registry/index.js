 ...
 * @param {object} [opts]
 * @param {string} [opts.installTarget] - Explicit install target path (overrides
 *   installPath for the installTarget field; useful when installPath is a
 *   temporary directory and the real target is elsewhere)
...
function registryAdd(slug, persona, installPath, regPath, opts = {}) {
  ...
  reg.personas[slug] = {
    ...
    path: installPath,
    installTarget: opts.installTarget || installPath,
