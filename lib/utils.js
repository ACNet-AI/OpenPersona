...
const OPENPERSONA_DIRECTORY = process.env.OPENPERSONA_DIRECTORY || 'https://openpersona.co';
const OPENPERSONA_TELEMETRY_ENDPOINT = process.env.OPENPERSONA_TELEMETRY_URL || `${OPENPERSONA_DIRECTORY}/api/telemetry`;
const OPENPERSONA_DATASETS_ENDPOINT = process.env.OPENPERSONA_DATASETS_URL || `${OPENPERSONA_DIRECTORY}/api/datasets`;
const OPENPERSONA_SKILLS_ENDPOINT = process.env.OPENPERSONA_SKILLS_URL || `${OPENPERSONA_DIRECTORY}/api/skills`;
