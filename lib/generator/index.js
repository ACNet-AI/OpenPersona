...
// Social builders (buildAgentCard, buildAcnConfig) → lib/generator-social.js
// Economy builders (loadEconomy, writeEconomyFiles) → lib/generator-economy.js
// ---------------------------------------------------------------------------
...
async function generate(personaPathOrObj, outputDir) {
  ...
  // capabilitiesSection — renders the "What You Can Do" block in soul/injection.md
  // populated from soul.character.capabilities (lifted by normalizeSoulInput)
